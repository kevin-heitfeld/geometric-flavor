...
To determine which operator dominates, we compute the numerical coefficients for our specific Calabi--Yau $\mathbb{P}_{11226}[12]$ with wrapped cycle $\Sigma_4 = D_1 + D_2$.
...
\bottomrule
\end{tabular}
\caption{Operator contributions to the top quark Yukawa coupling $Y_{33}$ for $\mathbb{P}_{11226}[12]$ with $\Sigma_4 = D_1 + D_2$. The $c_2$ term dominates, with $c_4$ and $c_6$ providing subleading corrections at the $28\%$ and $15\%$ level. Higher Chern classes are negligible.}
