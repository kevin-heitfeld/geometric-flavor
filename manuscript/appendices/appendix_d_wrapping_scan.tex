...
For our specific Calabi--Yau $\mathbb{P}_{11226}[12]$ with $h^{1,1} = 1$, there is only one K\"ahler modulus, so effectively we have:
\begin{equation}
...
\begin{enumerate}
    ...
    \end{equation}
    For $\mathbb{P}_{11226}[12]$, $c_2(D_1) = 66$, $c_2(D_2) = 48$, $D_1 \cdot D_2 = 36$, so:
    \begin{equation}
