...
The wrapped four-cycle $\Sigma_4 = D_1 + D_2 \subset X$ is a four-dimensional submanifold of the six-dimensional toroidal orbifold $X = T^6/(\ZZ_3 \times \ZZ_4)$. To perform numerical computations, we discretize $\Sigma_4$ using a finite element mesh.
...
The toroidal orbifold $T^6/(\ZZ_3 \times \ZZ_4)$ has discrete $\ZZ_3 \times \ZZ_4$ symmetries. Our numerical results should respect these symmetries:
\begin{equation}
