...
Our baseline calculation uses specific moduli values ($\tau = 1.2 + 0.8i$, $\rho = 1.0 + 0.5i$, $U_i \sim \mathcal{O}(1)$). A natural question is: how sensitive are our predictions to variations in these complex structure moduli?
