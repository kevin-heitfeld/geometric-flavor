...
This would require:
\begin{enumerate}
\item Explicit orbifold construction $T^6/(\mathbb{Z}_3 \times \mathbb{Z}_4)$ with $(h^{1,1}, h^{2,1}) = (3, 75)$, $\Gamma_0(3) \times \Gamma_0(4)$, $\tau = 2.69i$
...
\begin{enumerate}
\item Constructing explicit toroidal orbifold $T^6/(\mathbb{Z}_3 \times \mathbb{Z}_4)$ with $(h^{1,1}, h^{2,1}) = (3, 75)$, $\Gamma_0(3) \times \Gamma_0(4)$
