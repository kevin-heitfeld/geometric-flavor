...
\input{sections/03_calculation}
\input{sections/04_results}
\input{sections/05_predictions}
...
\appendix
\input{appendices/appendix_a_yukawa_details}
\input{appendices/appendix_b_operator_basis}
\input{appendices/appendix_c_kklt_uncertainty}
\input{appendices/appendix_d_wrapping_scan}
\input{appendices/appendix_e_modular_forms}
\input{appendices/appendix_f_numerical_methods}
\input{appendices/appendix_g_loop_corrections}
