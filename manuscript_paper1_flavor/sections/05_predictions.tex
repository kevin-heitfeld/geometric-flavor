...
Using our predicted neutrino masses ($m_1 = 1.4$ meV, $m_2 = 8.8$ meV, $m_3 = 50.3$ meV) from the seesaw mechanism with $k_\nu = (5,3,1)$ modular weights, and PMNS matrix elements from Section~\ref{sec:results}, we compute:
\begin{equation}
    \vev{m_{\beta\beta}} = 10.5 \text{ meV}.
    \label{eq:mbb_prediction}
\end{equation}

These absolute masses correspond to $\Sigma m_\nu = 60.5$ meV, well within the Planck cosmological bound $< 120$ meV \cite{Planck:2018vyg}.
