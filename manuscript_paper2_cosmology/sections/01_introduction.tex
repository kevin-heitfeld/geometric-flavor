...
The result is a \emph{unified string cosmology}: 25 observables (19 flavor + 6 cosmology) explained by the same geometric input—discrete brane wrapping numbers and orbifold structure—that determines SM flavor. Table~\ref{tab:observables_summary} summarizes the complete picture.
