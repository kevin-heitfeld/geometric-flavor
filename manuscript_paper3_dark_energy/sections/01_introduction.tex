...
where supergravity corrections ($\alpha'$ corrections 3.7\%, $g_s$ loops 1.2\%, flux backreaction 0.1\%) naturally suppress the tree-level prediction to match observations at 0.3$\sigma$.
