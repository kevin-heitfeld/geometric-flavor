...
\item $Z_3$ sector: $k = 3 \times 3^2 = 27$ ✓ (with $n_F = 3$)
\item $Z_4$ sector: $k = 4 \times 2^2 = 16$ ✓ (with effective $n_F = 2$)
\end{itemize}
...
\subsubsection*{✗ We Do Not Establish (Deferred to Future Work)}
