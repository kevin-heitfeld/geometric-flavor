...
\item Neutrino mass differences: $\Delta m_{21}^2 \approx 7.4 \times 10^{-5}$ eV$^2$, $\Delta m_{31}^2 \approx 2.5 \times 10^{-3}$ eV$^2$ $\checkmark$
\item PMNS mixing angles: $\theta_{12} \approx 33^\circ$, $\theta_{23} \approx 49^\circ$, $\theta_{13} \approx 8.6^\circ$ $\checkmark$
\item CP phase: $\delta_{\text{CP}} \approx 220^\circ$ (large CP violation) $\checkmark$
\end{itemize}
