...
\begin{equation}
N_{D3}^{\text{induced}} + N_{D3} + \bar{N}_{\overline{D3}} = \frac{\chi(X)}{24} = \frac{-144}{24} = -6,
\label{eq:tadpole}
\end{equation}
...
For our flux choice:
\begin{equation}
(n^1, n^2, \ldots, n^{76}) = (3, -2, 1, 5, 0, \ldots, 1), \quad (m_1, m_2, \ldots, m_{76}) = (-1, 4, 2, -3, 1, \ldots, 0),
