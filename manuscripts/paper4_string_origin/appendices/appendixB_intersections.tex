...
\end{equation}
giving $\chi = I_{\Sigma} \times (n_{F,b} - n_{F,a}) = 1 \times 3 = 3$ $\checkmark$.
...
\item Even with $\chi = 0$, intersections give chirality $\checkmark$
\end{itemize}
...
\begin{itemize}
\item \textbf{Phenomenological requirement}: Standard Model has 3 generations $\checkmark$
...
\item Generation number: $N_{\text{gen}} = I_{\Sigma} \times n_F = 1 \times 3 = 3$ $\checkmark$
